using System.Text;
using Co_OwnerManagementSystem.FinanceApi.Http;
...
app.MapGet("/api/ping", () => Results.Ok(new { ok = true, svc = "finance" }))
    .RequireAuthorization("public");

app.MapGet("/internal/v1/finance/ping", () => Results.Ok(new { ok = true, svc = "finance" }))
